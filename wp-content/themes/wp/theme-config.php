...
Redux::setSection( $opt_name, array(
	...
	'fields'           => array(
		array(
			'id'       => 'text-example',
			'type'     => 'text',
			'title'    => __( 'Описание рецепта', 'redux-framework-demo' ),
		...
		array(
			...
			'type'      => 'text',
			'title'     => __( 'Заголовок рецепта', 'redux-framework-demo' ),
			'desc'      => __( 'Заголовок', 'redux-framework-demo' ),
...
Redux::setSection( $opt_name, array(
    'title'      => __( 'Тема дня', 'redux-framework-demo' ),
    ...
    'fields'     => array(
        ...
        array(
            'id'       => 'switch-on',
            'type'     => 'switch',
            'title'    => __( 'Включить блок "Тема дня"', 'redux-framework-demo' ),
    ...
    array(
        'id'       => 'opt-textarea',
        'type'     => 'textarea',
        'title'    => __( 'Главная ссылка', 'redux-framework-demo' ),
        ...
        array(
            'id'       => 'opt-textarea1',
            'type'     => 'textarea',
            'title'    => __( 'Описание темы дня', 'redux-framework-demo' ),
            'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
            'desc'     => __( 'This is the description field, again good for additional info.', 'redux-framework-demo' ),
            'default'  => 'Default Text',
        ),
        array(
            'id'       => 'text-title',
            'type'     => 'text',
            'title'    => __( 'Заголовок блока Тема дня', 'redux-framework-demo' ),
            'desc'     => __( 'Описание', 'redux-framework-demo' ),
            'default'  => 'Тема дня',
        ),
    ),
